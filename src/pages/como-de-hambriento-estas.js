  ...
  <div className="flex flex-col items-center justify-center w-full bg-white">
    <div className="md:flex justify-center items-center md:flex-row-reverse">
      <div className="flex flex-col md:ml-16">
        ...
        <div className="font-serif text-3xl md:text-5xl mx-auto text-center max-w-sm leading-tight text-black md:text-left text-center py-2">¿Cómo de hambriento estás?</div>
      </div>
      <div className="flex flex-col mx-auto mx-auto py-8 md:py-2">
      ...
      <div className="font-mono text-grey-dark text-sm my-4 mx-auto"><Link to="/que-quieres-hacer/" className="no-underline text-grey-dark text-center md:text-left"> <FaLongArrowLeft />  Regresar</Link></div>
      </div>
