...
const IndexPage = () => (
  <div className="flex">
    ...
    <br/>
    <br/>
    <button className="border border-black text-black text-lg font-serif tracking-very-wide py-4 px-8 hover:bg-black hover:border-white hover:text-white">LOREM IPSUM</button>
    </div>
    <div className="flex-1"></div>
  </div>
);
