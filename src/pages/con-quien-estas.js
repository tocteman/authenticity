    ...
    <div className="flex flex-col justify-between">
      ...
      <div className="md:flex mx-auto my-4">
        <div className="md:w-1/2 flex flex-col">
          ...
          <button className="border-white border-2 my-2 mr-8 px-4 py-3 font-mono text-white uppercase cursor-default bg-black w-64">Conmigo mismo</button>
        </div>
        <div className="md:w-1/2 flex flex-col">
          <button className="border-white border-2 my-2 mr-8 px-4 py-3 font-mono text-white uppercase cursor-default bg-black w-64">Con mi pareja</button>
          <button className="border-white border-2 my-2 mr-8 px-4 py-3 font-mono text-white uppercase cursor-default bg-black w-64">Con los amigos</button>
          <button className="border-white border-2 my-2 mr-8 px-4 py-3 font-mono text-white uppercase cursor-default bg-black w-64">Con mi ligue de tinder</button>
        </div>
        </div>
